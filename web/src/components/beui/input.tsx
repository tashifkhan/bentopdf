    ...
    <div className={cn('flex flex-col gap-1.5', className, classNames?.root)}>
      {label ? (
        <label
          htmlFor={id}
          className={cn(
            'px-1 text-xs font-semibold text-muted-foreground',
            classNames?.label,
          )}
        >
          {label}
      ...
      <div
        ...
        className={cn(
          'relative h-10 overflow-hidden rounded-xl border bg-card transition-colors duration-200',
          'border-border',
          focused && !hasError && 'border-accent ring-2 ring-ring/30',
      ...
      >
        ...
        <input
          ...
          className={cn(
            'peer h-full w-full bg-transparent text-sm leading-6 text-foreground caret-accent outline-none',
