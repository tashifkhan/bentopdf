  ...
  return (
    ...
    >
      <motion.button
        ...
        className={cn(
          'mt-0.5 inline-flex size-5 shrink-0 items-center justify-center rounded-md border-2 outline-none transition-colors duration-200',
          'focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
          'disabled:cursor-not-allowed disabled:opacity-60',
          showMark
            ? 'border-accent bg-accent text-accent-foreground'
            : 'border-muted-foreground/50 bg-card hover:border-accent/70',
        )}
      >
