...
export function SelectTrigger({ className, children }: SelectTriggerProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        'relative z-10 flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-border bg-card px-3 text-sm text-foreground outline-none transition-colors',
        'hover:border-line-strong focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-ring/30',
...
export function SelectContent({ className, children }: SelectContentProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'absolute left-0 right-0 z-20 rounded-xl border border-border bg-card shadow-panel',
      ...
      <button
        ...
        className={cn(
          ...
          selected
            ...
            : 'text-muted-foreground hover:bg-accent-soft hover:text-foreground focus-visible:bg-accent-soft',
          'disabled:pointer-events-none disabled:opacity-50',
          className,
        )}
      >
